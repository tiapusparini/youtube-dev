...
<body>
      ...
      <nav class="container">
            ...
            <a class="navbar-brand" href="<?php echo(base_url("Admin")); ?>"><h1><img src="<?php echo(base_url("asset/images/logo2.png")) ?>" alt="" /></h1></a>
          </div>
          ...
          <div id="navbar" class="navbar-collapse collapse">
                <ul>
                  ...
                  <div class="header-top-right"> 
                    <div class="signin">
                      <a href="#" class="play-icon popup-with-zoom-anim" style="background: #800000;color: #ffffff;">Hai, <?php echo $this->session->userdata('nama'); ?></a>
