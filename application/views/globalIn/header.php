...
<body>
      ...
      <nav class="container">
            ...
            <a class="navbar-brand" href="<?php echo(base_url("User/home")); ?>"><h1><img src="<?php echo(base_url("asset/images/logo2.png")) ?>" alt="" /></h1></a>
          </div>
          ...
          <div id="navbar" class="navbar-collapse collapse">
                <ul>
                  ...
                  <div class="header-top-right">
                    <div class="signin">
                      <a href="<?php echo(base_url("Upload")); ?>" style="background: #800000;color: #ffffff;"><span class="glyphicon glyphicon-upload"></span> Upload</a>
                    </div>  
                    <div class="signin">
                      <a href="<?php echo base_url("User/profile") ?>" class="play-icon popup-with-zoom-anim" style="background: #800000;color: #ffffff;">Hai, <?php echo $this->session->userdata('nama'); ?></a>
                         
                    </div>
                    <div class="signin">
                      <a href="<?php echo(base_url("User/logout")); ?>" class="play-icon popup-with-zoom-anim" style="background: #800000;color: #ffffff;">Logout</a>   
                    </div>
      					</ul>
